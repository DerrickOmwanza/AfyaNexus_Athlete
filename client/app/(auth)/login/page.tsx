          ...
          <div className="bg-white/[0.06] backdrop-blur-xl border border-white/10 rounded-2xl p-8 shadow-2xl">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <button
                ...
                className="w-full bg-brand-green text-white py-3.5 rounded-xl font-semibold hover:bg-emerald-400 transition-all disabled:opacity-50 hover:shadow-lg hover:shadow-brand-green/30 hover:scale-[1.02] mt-2"
              >
                {loading ? (
